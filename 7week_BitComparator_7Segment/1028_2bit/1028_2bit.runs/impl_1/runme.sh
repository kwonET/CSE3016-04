...
HD_PWD='C:/Users/D-105/tuesday/1028_2bit/1028_2bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bit.tcl -notrace
