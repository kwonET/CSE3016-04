...
HD_PWD='C:/Users/D-105/tuesday/1028_parity1/1028_parity1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parity1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parity1.tcl -notrace
