...
HD_PWD='C:/Users/D-105/tuesday/1028_parity1/1028_parity1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parity1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parity1.tcl
