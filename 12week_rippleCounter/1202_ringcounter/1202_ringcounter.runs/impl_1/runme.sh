...
HD_PWD='C:/Users/D-105/1202_ringcounter/1202_ringcounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rc.tcl -notrace
