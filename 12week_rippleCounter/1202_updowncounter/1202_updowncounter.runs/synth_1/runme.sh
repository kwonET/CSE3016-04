...
HD_PWD='C:/Users/D-105/1202_updowncounter/1202_updowncounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log udc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source udc.tcl
