...
HD_PWD='C:/Users/D-105/1125_counter2bit/1125_counter2bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter2.tcl -notrace
