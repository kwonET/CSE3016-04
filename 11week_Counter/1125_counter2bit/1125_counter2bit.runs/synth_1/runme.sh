...
HD_PWD='C:/Users/D-105/1125_counter2bit/1125_counter2bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter2.tcl
